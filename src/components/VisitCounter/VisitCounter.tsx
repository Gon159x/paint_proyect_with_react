...
export function VisitCounter() {
  ...
  return (
    <Tooltip
      visible={error && !loading ? true : false}
      // visible={true}
      content="Hemos tenido problemas descargando la cantidad de usuarios que han visitado la página. Reintentaremos en unos segundos."
    >
